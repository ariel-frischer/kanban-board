...
const Container = styled.a<any>`
  ...
  box-shadow: ${({ isDragging }) =>
    isDragging ? `2px 2px 1px ${colors.common.white[70]}` : "none"};
  box-sizing: border-box;
  padding: ${grid}px;
...
function QuoteItem(props: Props) {
  ...
  return (
    <Container
      ...
      data-index={index}
      aria-label={`${quote.author.name} quote ${quote.description}`}
    >
